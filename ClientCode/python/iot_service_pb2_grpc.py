...
class IoTServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Authenticate = channel.unary_unary(
                '/iot_service.IoTService/Authenticate',
                request_serializer=iot__service__pb2.TryLogin.SerializeToString,
                response_deserializer=iot__service__pb2.codigoHash.FromString,
                )
...
def add_IoTServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Authenticate': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=iot__service__pb2.TryLogin.FromString,
                    response_serializer=iot__service__pb2.codigoHash.SerializeToString,
            ),
    }
...
class IoTService(object):
    ...
    def Authenticate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iot_service.IoTService/Authenticate',
            iot__service__pb2.TryLogin.SerializeToString,
            iot__service__pb2.codigoHash.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
